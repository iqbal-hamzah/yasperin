...
<!-- /TinyMCE -->
   				...
   				<div class="top">
    				<h2 align="center" style="font-family:georgia">Tambah Buku</h2>
    				
   				</div>
   
                <div class="bottom" style="font-family:georgia;">
				<br/><br/>
   			<form method="post" enctype="multipart/form-data" action="controller/doTambahBuku.php">
				<table border="0"  style="margin-left:15px"cellspacing="10px" cellspadding="10px">
				
				<tr>
				<td>Judul Buku</td>
				<td><input type="text" name="txtname" size="33"/></td>
				</tr>
				...
				<tr>
				<td>Penulis</td>
				<td><input type="text" name="txtpenulis"/></td>
				</tr>				
				...
				<tr>
				<td>Sinopsis</td>
				<td><textarea id="elm1" name="txtdesc" rows="10"></textarea>
				</td>
				</tr>
