...
<div id="middlePanel">
   				<div class="top">
    				<h2 align="center">Detail Transaction</h2>
...
if (!empty($_GET['idpemesanan'])) {
	...
	<table width="671" border="1" cellspacing="0" cellpadding="2" align="center">
		...
		<a href="kelola_transaksi.php" style="text-decoration:none"><input type="button" value=" Kembali "/></a>	<br/><br/>
